...
public class PaymentEndpoint {
    ...
    public static final String REQUEST_LOCAL_NAME = "paymentRequest";
    ...
    public PaymentResponse processPayment(@RequestPayload PaymentRequest paymentRequest) {
        ...
        try {
            logger.debug("The payment are  processing.... ");
    ...
    @PayloadRoot(localPart = "EncryptedData", namespace = "http://www.w3.org/2001/04/xmlenc#")
    @ResponsePayload
    public PaymentResponse processPaymentEncrypt(@RequestPayload PaymentRequest paymentRequest) {
