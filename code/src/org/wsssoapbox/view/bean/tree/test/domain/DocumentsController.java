package org.wsssoapbox.view.bean.tree.test.domain;
...
public class DocumentsController {
	...
	public DocumentsController() {
		...
		TreeNode primefaces = new DefaultTreeNode(new Document("PrimeFaces",
				"-", "Folder"), documents);
		...
		TreeNode primelogo = new DefaultTreeNode("picture", new Document(
