...
public class BindingFaultBean implements Serializable  {
	...
	public String toString() {
		return "BindingFaultBean [ref=" + ref + ", name=" + name + ", documentation=" + documentation
				+ ", HTTPBinding4Wsdl11=" + HTTPBinding4Wsdl11 + ", HTTPBinding4Wsdl20=" + HTTPBinding4Wsdl20
				+ ", HttpContentEncoding=" + HttpContentEncoding + ", MIMEBinding4Wsdl11=" + MIMEBinding4Wsdl11
				+ ", otherAttributes=" + otherAttributes + ", otherElements=" + otherElements
				+ ", SOAP11Binding4Wsdl11=" + SOAP11Binding4Wsdl11 + ", SOAP12Binding4Wsdl11=" + SOAP12Binding4Wsdl11
				+ ", SOAP12Binding4Wsdl20=" + SOAP12Binding4Wsdl20 + "]";
	}
