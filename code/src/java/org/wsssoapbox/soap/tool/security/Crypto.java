...
public class Crypto {
   ...
   public static void main(String args[]) {
      try {
         ...
         // Encrypt
         encrypter.encrypt(new FileInputStream("C:/test.txt"), new FileOutputStream("C:/testEncrypted.txt"));
         // Decrypt
         encrypter.decrypt(new FileInputStream("c:/testEncrypted.txt"), new FileOutputStream("c:/testDecrypted.txt"));
