 ...
 * @author  Peter
 */
public class BindingInputBean implements Serializable {
	/**
	 * 
	 */
	...
	public String toString() {
		return "BindingInputBean [name=" + getName() + ", documentation=" + getDocumentation() + ", HTTPBinding4Wsdl11="
				+ getHTTPBinding4Wsdl11() + ", HTTPBinding4Wsdl20=" + getHTTPBinding4Wsdl20() + ", HttpContentEncoding="
				+ getHttpContentEncoding() + ", MIMEBinding4Wsdl11=" + getMIMEBinding4Wsdl11() + ", otherAttributes="
				+ getOtherAttributes() + ", otherElements=" + getOtherElements() + ", SOAP11Binding4Wsdl11="
				+ getSOAP11Binding4Wsdl11() + ", SOAP12Binding4Wsdl11=" + getSOAP12Binding4Wsdl11() + ", SOAP12Binding4Wsdl20="
